...
<html lang="en">
    ...
    <body>
        ...
        <h2>Files</h2>
        <p>This utility allows you to view files associated with the connected Predator instance.</p>
        <br>
        <main>
            ...
            <div>
                <?php
                $allowed_extensions = array("csv", "txt", "json", "py"); // These are the extensions that can be shown by this utility.
                ...
                if (isset($selected_directory) == true) { // Check to see if the user has selected a directory.
                    ...
                    } else if ($selected_directory == "instance") { $directory_path = $config["instance_directory"];
